...
Public Class Level_4
    ...
    Private Sub check(ByVal row As Integer, ByVal col As Integer)
        If (row * 8 - (8 - col)) = winningSquare And checkNumber = 33 Then
        ...
        ElseIf row <= 0 OrElse row > 8 OrElse col <= 0 OrElse col > 8 OrElse Block(row, col) = True Then
            gameOver()
            reset()
        ElseIf (row * 8 - (8 - col)) = winningSquare And checkNumber <> 33 Then
    ...
    Private Sub Level_4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        winningSquare = 24
        startingSquare = 25
    End Sub
